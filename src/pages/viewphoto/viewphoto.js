...
var ViewphotoPage = /** @class */ (function () {
    function ViewphotoPage(viewCtrl, navCtrl, navParams) {
        this.viewCtrl = viewCtrl;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.imgurl = navParams.get('imgurl');
    }
    ViewphotoPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad ViewphotoPage');
    };
    ViewphotoPage.prototype.goBack = function () {
...
export { ViewphotoPage };
//# sourceMappingURL=viewphoto.js.map